...
import com.multiplex.replication.security.ReplicationSecureStore
...
class EnrollmentWorkflowInstrumentedTest {
    ...
    @Test fun failedCancellationSurvivesRepositoryRecreation() = runBlocking {
        ...
        catch (_: com.multiplex.replication.security.MobileReplicationException.Locked) { }
        ...
        catch (_: com.multiplex.replication.security.MobileReplicationException.RecoveryRequired) { }
    ...
    @Test fun recoveryRequiresConfirmationAndCanBeDismissed() {
        ...
        compose.onNodeWithText(context.getString(com.multiplex.mobile.R.string.enrollment_bundle_back)).performTouchInput { click() }
        compose.runOnIdle { assertEquals(0, recovered) }
        compose.onNodeWithText("Review enrollment recovery").performScrollTo().performTouchInput { click() }
