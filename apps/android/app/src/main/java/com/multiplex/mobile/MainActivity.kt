...
import com.multiplex.mobile.data.NativeMobileVaultDecryptor
import com.multiplex.mobile.data.SharedPreferencesDeviceIdentityStore
import com.multiplex.mobile.data.SharedPreferencesEncryptedVaultStore
...
import com.multiplex.mobile.ui.UnifiedMobileApp

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        // The app is dark whatever the phone is set to, so the system bars are told once: light
        // icons over a transparent scrim. Left to the system they followed the phone, and a light
        // phone put dark status icons on the dark canvas and a white strip under the gesture bar.
        enableEdgeToEdge(
