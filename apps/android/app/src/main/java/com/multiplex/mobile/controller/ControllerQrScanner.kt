...
fun ControllerQrScannerDialog(
    ...
    AlertDialog(
        ...
        title = { Text(stringResource(com.multiplex.mobile.R.string.scan_pairing_code)) },
        text = {
            Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
                if (granted) {
                    ...
                    Text(stringResource(com.multiplex.mobile.R.string.camera_scan_hint))
                } else {
                    Text(stringResource(com.multiplex.mobile.R.string.camera_permission_hint))
                    Button(onClick = { permission.launch(Manifest.permission.CAMERA) }) {
                        Text(stringResource(com.multiplex.mobile.R.string.allow_camera))
                    }
                }
            }
        },
