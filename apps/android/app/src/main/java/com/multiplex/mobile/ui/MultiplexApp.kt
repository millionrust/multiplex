...
import com.multiplex.mobile.controller.BoundedTerminalSnapshot
import com.multiplex.mobile.controller.ControllerTerminalCursor
import com.multiplex.mobile.controller.ControllerTerminalFollowTarget
import com.multiplex.mobile.controller.TerminalInteraction
import com.multiplex.mobile.controller.styledTerminalRow
...
import com.multiplex.mobile.ssh.TerminalConnectionState
import com.multiplex.mobile.terminal.encodeTerminalInput
import com.multiplex.mobile.terminal.estimateTerminalGrid

private data class MultiplexMobileColors(
...
private fun slateMobileColors(theme: SlateTheme): MultiplexMobileColors {
...
private val LocalMultiplexMobileColors = staticCompositionLocalOf { LightMobileColors }

private val AppBackground: Color
    @Composable get() = LocalMultiplexMobileColors.current.appBackground
private val PanelBackground: Color
    @Composable get() = LocalMultiplexMobileColors.current.panelBackground
private val PanelAltBackground: Color
    @Composable get() = LocalMultiplexMobileColors.current.panelAltBackground
private val PanelBorder: Color
    @Composable get() = LocalMultiplexMobileColors.current.panelBorder
private val PrimaryText: Color
    @Composable get() = LocalMultiplexMobileColors.current.primaryText
private val SecondaryText: Color
    @Composable get() = LocalMultiplexMobileColors.current.secondaryText
private val TerminalBackground: Color
    @Composable get() = LocalMultiplexMobileColors.current.terminalBackground
private val TerminalForeground: Color
    @Composable get() = LocalMultiplexMobileColors.current.terminalForeground
private val TerminalMuted: Color
    @Composable get() = LocalMultiplexMobileColors.current.terminalMuted
private val Accent: Color
    @Composable get() = LocalMultiplexMobileColors.current.accent
private val AccentSurface: Color
    @Composable get() = LocalMultiplexMobileColors.current.accentSurface
private val Success: Color
    @Composable get() = LocalMultiplexMobileColors.current.success
private val SuccessSurface: Color
    @Composable get() = LocalMultiplexMobileColors.current.successSurface
private val SuccessBorder: Color
    @Composable get() = LocalMultiplexMobileColors.current.successBorder
private val Warning: Color
    @Composable get() = LocalMultiplexMobileColors.current.warning
private val WarningSurface: Color
    @Composable get() = LocalMultiplexMobileColors.current.warningSurface
private val WarningBorder: Color
    @Composable get() = LocalMultiplexMobileColors.current.warningBorder
private val Danger: Color
    @Composable get() = LocalMultiplexMobileColors.current.danger
private val DangerText: Color
    @Composable get() = LocalMultiplexMobileColors.current.dangerText
private val DangerSurface: Color
    @Composable get() = LocalMultiplexMobileColors.current.dangerSurface
private val DangerBorder: Color
    @Composable get() = LocalMultiplexMobileColors.current.dangerBorder
