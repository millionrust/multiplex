...
ACCEPTANCE_FIXTURE="${CONTROLLER_ROUTE_ACCEPTANCE_FIXTURE:-$ROOT_DIR/MultiplexMobileTests/Fixtures/remote-route-acceptance-v1.json}"
TEMP_DIR="$(mktemp -d "${TMPDIR:-/tmp}/multiplex-ios-routes.XXXXXX")"
...
xcrun swiftc \
  ...
  "$ROOT_DIR/MultiplexMobile/Models/ControllerRemoteRoute.swift" \
  "$ROOT_DIR/MultiplexMobile/Controller/AppleControllerRouteCoordinator.swift" \
