...
final class DirectSSHIntegrationTests: XCTestCase {
    func testDirectSSHAttachesToPersistentTmuxSessionAndSurvivesReconnect() async throws {
        ...
        let secretRef = "multiplex-mobile-test-private-key"
        let host = MobileHost(
            id: "ios-live-ssh",
            label: "iOS Live SSH",
            vaultId: nil,
        ...
        do {
            ...
            try await firstClient.send(Data("echo ios-smoke-first > ~/multiplex-ios-smoke\n".utf8))
        ...
        do {
            ...
            try await secondClient.send(Data("cat ~/multiplex-ios-smoke\n".utf8))
...
private struct LiveSSHSmokeConfig {
    ...
    private static func fileValues() -> [String: String] {
        let fileURL = URL(fileURLWithPath: #filePath)
            ...
            .appendingPathComponent(".multiplex-mobile-live-ssh.properties")
