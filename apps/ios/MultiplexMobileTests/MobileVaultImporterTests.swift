...
final class MobileVaultImporterTests: XCTestCase {
    ...
    private let plaintextVaultData = Data("""
    {
      ...
      "hosts": [{
        ...
        "port": 22,
        "username": "ubuntu",
        "auth": {"kind": "private_key", "identity_id": "identity-1", "secret_ref": "multiplex-mobile://identity/identity-1/private-key"},
        "jump_host_id": null,
    ...
    func testPlaintextVaultDecodesPersistentTmuxHost() throws {
        ...
        XCTAssertEqual(
            ...
            "multiplex-mobile://identity/identity-1/private-key"
        )
