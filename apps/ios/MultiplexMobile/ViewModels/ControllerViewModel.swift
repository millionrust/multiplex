...
final class ControllerViewModel: ObservableObject {
    ...
    private static func loadDeviceID(defaults: UserDefaults) -> UUID {
        let key = "multiplex.controller.device_uuid"
    ...
    private static let selectedRouteDefaultsKey = "multiplex.controller.selected_route.v1"
    private static let selectedHostDefaultsKey = "multiplex.controller.selected_host.v1"
}
