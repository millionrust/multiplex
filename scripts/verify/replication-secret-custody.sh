...
cargo fmt --all -- --check
cargo test -p multiplex-replication-security --test secret_custody_contract --locked -- --test-threads=1
cargo test -p multiplex-replication-security --test secret_custody_contract --locked --features os-keyring -- --test-threads=1
cargo test -p multiplex-replication-security --test authority_lifecycle_contract --locked -- --test-threads=1
cargo clippy -p multiplex-replication-security --all-targets --locked --features os-keyring -- -D warnings
