...
mod tests {
    ...
    fn activity_replay_persists_attention_and_exact_read_watermarks_across_restart() {
        ...
        let needs_input = multiplex_domain::ActivityAggregate {
            state: multiplex_domain::ActivityState::NeedsInput,
            confidence: multiplex_domain::ActivityConfidence::Verified,
            effective_sequence: multiplex_domain::HostSequence::new(1),
            source_kind: multiplex_domain::ActivitySourceKind::Approval,
            source_id: "store-test".to_string(),
            stale: false,
            attention_reason: Some(multiplex_domain::AttentionReason::Approval),
