...
impl<B: ReplicationSecretBackend> ReplicationProductService<B> {
    ...
    fn open_candidate(
        ...
        let envelope =
            multiplex_replication_security::ReplicationEnvelope::from_sealed_payload(payload)?;
    ...
    fn rekey_document(
        &self,
        snapshot: &super::ReplicationRepositorySnapshot,
        next_epoch_key: &multiplex_replication_security::ReplicationEpochKey,
        next_policy: &multiplex_domain::ReplicationPolicy,
        ...
        for entry in &snapshot.document.entries {
            ...
            let old_envelope =
                multiplex_replication_security::ReplicationEnvelope::from_sealed_payload(
                    old_payload,
                )?;
