...
fn decode_secret_references(
    ...
    if encoded.len() > multiplex_replication_security::MAX_REPLICATION_RETAINED_EPOCH_KEYS {
    ...
    D: Deserializer<'de>,
{
    ...
    impl<'de> Visitor<'de> for SecretReferenceVisitor {
        ...
        where
            A: SeqAccess<'de>,
        {
            let limit = multiplex_replication_security::REPLICATION_SECRET_REFERENCE_BYTES;
    ...
    D: Deserializer<'de>,
{
    ...
    impl<'de> Visitor<'de> for SecretReferencesVisitor {
        ...
        where
            A: SeqAccess<'de>,
        {
            let limit = multiplex_replication_security::MAX_REPLICATION_RETAINED_EPOCH_KEYS;
