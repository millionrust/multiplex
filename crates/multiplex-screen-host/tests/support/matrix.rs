...
//! [`multiplex_screen_transport::Class`] exists. Only the video class is allowed to lose anything,
...
use multiplex_domain::ControllerDeviceId;
use multiplex_screen_codec::{FrameBuffer, Rect, Size};
use multiplex_screen_host::{Rung, ScreenHost, ScreenHostHandle};
use multiplex_screen_protocol::{
    Class, FeatureSet, FrameReader, Message, Profile, SurfaceInfo, encode_frame,
};
use multiplex_screen_session::{HostConfig, ViewerSession};
