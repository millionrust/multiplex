...
//!
//! The wrapping is here rather than in `multiplex-screen-video` because the trait is this crate's:
//! the encoder crate knows about HEVC and long-term references, and nothing about sessions.

use multiplex_screen_video::{Encoded, EncoderConfig, HevcEncoder, Request};
