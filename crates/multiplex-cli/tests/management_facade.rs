...
use common::*;
use multiplex_cli::{Cancellation, CliData, CliError, ErrorCode, ManagementCommand};
use multiplex_domain::{
    CommandId, HostInstanceId, HostLifecycle, HostedSessionState, Revision, SessionMutation,
};
use multiplex_store::{HostLease, HostMetadata};
...
fn mutation(data: CliData) -> multiplex_cli::SessionMutationData {
