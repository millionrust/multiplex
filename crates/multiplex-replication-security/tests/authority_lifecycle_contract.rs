...
fn packages_hex(
    distribution: &multiplex_replication_security::ReplicationEpochDistribution,
...
fn revoked_device_is_excluded_and_policy_rejects_post_cutoff_history() {
    ...
    multiplex_domain::ReplicatedVersion::new(
        revoked.clone(),
        accepted,
    ...
    let rejected = multiplex_domain::ReplicatedVersion {
