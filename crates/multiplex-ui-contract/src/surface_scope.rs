...
pub fn files_for_surface(surface: &str) -> Option<&'static [SurfaceFile]> {
    match surface {
        "vault-keys-snippets" => Some(&[
            SurfaceFile {
                path: "crates/multiplex-desktop/src/ui/app/key_lifecycle.rs",
                marked: false,
            },
            SurfaceFile {
                path: "crates/multiplex-desktop/src/ui/app/vault_key_snippet.rs",
                marked: false,
            },
            SurfaceFile {
                path: "crates/multiplex-desktop/src/ui/snippet.rs",
                marked: false,
            },
            SurfaceFile {
                path: "crates/multiplex-desktop/src/ui/app/library.rs",
                marked: true,
            },
            SurfaceFile {
                path: "crates/multiplex-desktop/src/ui/app/mod.rs",
                marked: true,
            },
        ]),
        "settings" => Some(&[
            ...
            SurfaceFile {
                path: "crates/multiplex-desktop/src/ui/app/notification_settings.rs",
                marked: false,
            },
            SurfaceFile {
                path: "crates/multiplex-desktop/src/ui/app/cli_status.rs",
                marked: false,
            },
            SurfaceFile {
                path: "crates/multiplex-desktop/src/ui/app/remote_devices.rs",
                marked: false,
            },
            SurfaceFile {
                path: "crates/multiplex-desktop/src/ui/app/remote_terminals.rs",
                marked: false,
            },
            SurfaceFile {
                path: "crates/multiplex-desktop/src/ui/settings.rs",
                marked: false,
            },
            SurfaceFile {
                path: "crates/multiplex-desktop/src/ui/app/settings_surface.rs",
                marked: false,
            },
            SurfaceFile {
                path: "crates/multiplex-desktop/src/ui/app/mod.rs",
        ...
        "agent-canvas" => Some(&[
            SurfaceFile {
                path: "crates/multiplex-desktop/src/ui/app/canvas.rs",
                marked: false,
            },
            SurfaceFile {
                path: "crates/multiplex-desktop/src/ui/app/workspace.rs",
                marked: false,
            },
        ]),
        "terminal-chrome" => Some(&[
            SurfaceFile {
                path: "crates/multiplex-desktop/src/ui/render_terminal.rs",
                marked: false,
            },
            SurfaceFile {
                path: "crates/multiplex-desktop/src/ui/app/workspace.rs",
