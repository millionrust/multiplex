...
pub fn fingerprint_executable(
    path: &Path,
) -> std::io::Result<multiplex_domain::ExecutableFingerprint> {
    ...
    Ok(multiplex_domain::ExecutableFingerprint {
        file_identity,
        size: metadata.len(),
        modified_nanos,
...
pub struct ProcessObservationEngine {
    expected_token: multiplex_domain::ProcessToken,
...
impl ProcessObservationEngine {
    pub fn new(expected_token: multiplex_domain::ProcessToken) -> Self {
        Self {
            expected_token,
...
mod tests {
    ...
    fn observation(
        ...
        token: Option<multiplex_domain::ProcessToken>,
        descends: bool,
    ) -> ProcessObservation {
        ProcessObservation {
            observed_at_nanos: 0,
    ...
    fn process_observation_managed_requires_exact_host_token_and_descendant() {
        ...
        let token = multiplex_domain::ProcessToken::new(host, 42, 1);
