...
use multiplex_relay_protocol::RelayDiagnosticCode;
use multiplex_relay_server::{RelayMetadataStore, RelayStoreFault};
use std::fs;
...
fn configuration_and_error_debug_views_redact_protected_details() {
    ...
    let error = multiplex_relay_server::RelayServerError::with_source(
