...
) -> Result<&multiplex_domain::PairedDeviceRecord, ListenerError> {
    authority
        .devices
        .iter()
        .find(|device| {
...
mod tests {
    use super::*;
    use multiplex_controller_security::ControllerCapability as SecurityCapability;
    use multiplex_domain::{
    ...
    fn authority(
        ...
        let device_key =
            multiplex_controller_security::device_public_key_from_private(device_private);
        let capabilities = ControllerCapabilities::default()
            .with(multiplex_domain::ControllerCapability::ObserveSessions)
            .with(multiplex_domain::ControllerCapability::AttachOutput);
        ControllerDeviceAuthority {
            ...
            devices: vec![multiplex_domain::PairedDeviceRecord {
