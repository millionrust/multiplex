...
fn completion(command_id: multiplex_domain::CommandId, applied: bool) -> Vec<ControllerResponse> {
...
fn error_response(command_id: multiplex_domain::CommandId) -> ControllerResponse {
