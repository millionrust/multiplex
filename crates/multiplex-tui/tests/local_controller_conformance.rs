...
use multiplex_cli::{Cancellation, ErrorCode, ManagementCommand as CliManagementCommand};
use multiplex_domain::{CommandId, Revision};
use multiplex_tui::{
...
fn assert_stale_cli_is_non_mutating(
    ...
    seed: &SeededStore,
    service: &multiplex_cli::LocalCommandService,
) {
