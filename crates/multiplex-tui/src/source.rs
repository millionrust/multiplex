...
fn session_state(state: multiplex_domain::HostedSessionState) -> &'static str {
    use multiplex_domain::HostedSessionState as State;
    match state {
        State::Draft => "draft",
...
fn activity_state(state: multiplex_domain::ActivityState) -> &'static str {
    use multiplex_domain::ActivityState as State;
    match state {
