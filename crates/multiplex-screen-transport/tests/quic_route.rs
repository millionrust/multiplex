...
use multiplex_screen_transport::quic::{ALPN, IrohTransport};
use multiplex_screen_transport::{Class, Delivery, Transport};
...
async fn a_video_frame_larger_than_a_datagram_is_refused_rather_than_split() {
    ...
    tokio::task::spawn_blocking(move || {
        ...
        assert_eq!(
            ...
            Err(multiplex_screen_transport::TransportError::TooLarge)
        );
