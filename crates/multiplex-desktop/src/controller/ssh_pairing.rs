...
mod unix {
    ...
    use multiplex_domain::PairingOfferId;
    ...
    fn protocol_error(error: multiplex_controller_listener::ListenerError) -> std::io::Error {
...
impl SshPairingBroker {
    ...
    pub fn poll(&mut self) -> Option<multiplex_controller_listener::SshHostPairingPrompt> {
        None
    }

    pub fn decide(
        &mut self,
        _offer_id: multiplex_domain::PairingOfferId,
        _decision: multiplex_controller_listener::SshHostPairingDecisionValue,
    ) -> std::io::Result<()> {
        Err(std::io::Error::new(
    ...
    pub fn pending_offer_id(&self) -> Option<multiplex_domain::PairingOfferId> {
        None
    }
}
