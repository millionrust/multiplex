...
use multiplex_controller_security::CapabilitySet;
...
async fn run(
    ...
    host_key: multiplex_controller_security::HostStaticPublicKey,
    private: multiplex_controller_security::StaticPrivateKey,
