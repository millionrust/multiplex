...
use multiplex_store::{ControllerDeviceRepository, ControllerDeviceStoreError};
...
mod tests {
    ...
    use multiplex_domain::{ControllerCapability, DeviceStoreRevision, HostIdentitySecretRef};
    ...
    fn controller_pairing_synthetic_transport_persists_before_ack_and_reconciles_lost_ack() {
        ...
        let device_key =
            multiplex_controller_security::device_public_key_from_private(&device_static);
        assert_eq!(
            coordinator
