        ...
        v_flex()
            ...
            .child(inspector_row(
                ...
                match control {
                    ...
                    multiplex_screen_protocol::ControlHolder::AnotherDevice => {
                        localization::remote_screen_control_another()
                    }
                    multiplex_screen_protocol::ControlHolder::Nobody => {
                ...
                h_flex()
                    ...
                    .child(
                        gpui_component::button::Button::new("remote-screen-control")
                            ...
                            .ghost()
                            .label(
                                if control == multiplex_screen_protocol::ControlHolder::You {
