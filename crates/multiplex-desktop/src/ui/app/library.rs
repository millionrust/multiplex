...
use multiplex_ui_contract::{MessageId, SettingsSectionId};
    ...
    pub(super) fn render_settings_view(&self, cx: &Context<Self>) -> Div {
        ...
        let sessions_card = self.settings_section_card(
            ...
            v_flex()
                ...
                .child(self.settings_divider())
                .child(self.settings_choice_row(
                    library_copy(MessageId::SettingsPersistentSessionsLabel),
                    library_copy(MessageId::SettingsPersistentSessionsDescription),
                    self.segmented_control(
                        "settings-persistent-sessions",
                        [
                            (
                                true,
                    ...
                    h_flex()
                        ...
                        .child(
                            Icon::new(match crate::diagnostics::status() {
                                multiplex_diagnostics::DiagnosticStatus::Healthy => {
                                    IconName::CircleCheck
                                }
                                multiplex_diagnostics::DiagnosticStatus::Dropping => {
                                    IconName::TriangleAlert
                                }
                                multiplex_diagnostics::DiagnosticStatus::DiskError => {
                                    IconName::CircleX
                                }
                                multiplex_diagnostics::DiagnosticStatus::Disabled => {
                                    IconName::CircleX
                                }
                            })
