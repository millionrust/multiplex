...
impl TermiRustApp {
    ...
    fn library_sftp_semantic_snapshot(&self, cx: &App) -> SftpSemanticSnapshot {
        ...
        let entries = listing
            ...
            .take(multiplex_ui_contract::MAX_SFTP_ROWS)
            .collect::<Vec<_>>();
    ...
    fn workspace_sftp_semantic_snapshot(&self, workspace_id: u64) -> SftpSemanticSnapshot {
        ...
        let mut rows = browser
            .entries
            .iter()
            .take(multiplex_ui_contract::MAX_SFTP_ROWS.saturating_sub(1))
            .enumerate()
        ...
        controls.extend(
            rows.iter()
                .filter(|row| row.id.kind == multiplex_ui_contract::SftpRowKind::RemoteEntry)
                .map(|row| {
                    sftp_control(
    ...
    fn activate_sftp_row(
        ...
        match row_id.kind {
            multiplex_ui_contract::SftpRowKind::LocalEntry => {
                if let Some(entry) =
            ...
            multiplex_ui_contract::SftpRowKind::Host => {
            ...
            multiplex_ui_contract::SftpRowKind::RemoteEntry => {
            ...
            multiplex_ui_contract::SftpRowKind::Transfer => {}
        }
    }
