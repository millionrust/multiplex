...
const SYSTEM_TOKENS: multiplex_ui_contract::DesignTokens =
    multiplex_ui_contract::DesignTokens::new(ThemeKind::System);
...
impl AccessibilityHarness {
    ...
    fn sync_bridge(&mut self) {
        let result = (|| {
            ...
            let bridge = self.bridge.as_mut().ok_or_else(|| {
                multiplex_ui_contract::SemanticError::new(
    ...
    fn tokens(&self) -> multiplex_ui_contract::DesignTokens {
        multiplex_ui_contract::DesignTokens::new(self.model.configuration().theme)
    }
...
fn progress_control(
    ...
    let tokens = multiplex_ui_contract::DesignTokens::new(ThemeKind::System);
    div()
        .id(id)
        .h(px(tokens
