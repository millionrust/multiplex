...
use multiplex_ui_contract::{ColorValue, DesignTokens, StatusKind, StatusVisual, ThemeKind};
...
pub fn motion_duration(value: multiplex_ui_contract::DurationValue) -> std::time::Duration {
...
/// Six digits of a pairing code, with the input's own padding.
pub const PAIRING_CODE_WIDTH: f32 = SPACE_9 + SPACE_8;
