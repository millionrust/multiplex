use multiplex_client::HostReconciliationErrorCode;
use multiplex_diagnostics::{DiagnosticStatus, DiagnosticUsage, ExportErrorCode};
...
pub fn recovery_view_model(
    ...
    plan: Option<&multiplex_store::RecoveryPlan>,
    busy: bool,
) -> RecoveryViewModel {
    RecoveryViewModel {
...
pub fn host_recovery_view_model(
    route: SessionLaunchRoute,
    state: HostedSessionState,
    plan: Option<&multiplex_client::HostReconciliationPlan>,
    busy: bool,
...
mod health {
    use super::*;
    use multiplex_store::{HealthEvidenceCode, HealthFinding};
