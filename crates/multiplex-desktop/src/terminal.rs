...
mod tests {
    ...
    fn named_colors_and_cursor_come_from_the_slate_terminal_tokens() {
        ...
        let expected = |value: multiplex_ui_contract::ColorValue| {
    ...
    fn a_wrapped_tab_paints_the_same_colours_as_a_plain_one() {
        ...
        let Ok(tmux) = multiplex_tmux::Tmux::discover() else {
        ...
        let mut arguments = multiplex_tmux::appearance::client_flags(&[
            multiplex_tmux::appearance::TRUECOLOR_FEATURE,
            multiplex_tmux::appearance::SYNCHRONIZED_UPDATE_FEATURE,
        ]);
        arguments.extend(
            [
                "-f",
